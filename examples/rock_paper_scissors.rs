...
use finite_state_machine::rock_paper_scissors::{self, Input as RockPaperScissorsInput, Output as RockPaperScissorsOutput};

fn main() -> Result<(), std::io::Error> {
    let mut rock_paper_scissors_finite_state_machine = rock_paper_scissors::new_finite_state_machine();
